...
<div class="row m-0 p-0">
	<div class="col-md-12 p-2 stockDiv">
  		<div class=" row">
			 ...
			 <div class="col-md-4" style="align-content: center;">
				<select class="form-select" id="stockOpt">
				  ...
				  <option value="1">ID CARDS - Single Side</option>
				  <option value="2">ID CARDS - Double Side</option> 
		...
		<div class=" row mt-1">
			<label for="Stock Name" class="col-md-2 col-form-label">Pouches</label>
			<div class="col-md-4" style="align-content: center;">
				<select class="form-select" id="machineOpt">
				  <option value="0">-Select-</option>
				  <option value="65 X 95 - 250 Mic.">65 X 95 - 250 Mic.</option>
				  <option value="65 X 95 - 350 Mic.">65 X 95 - 350 Mic.</option>
				</select>  
			</div> 			
			...
			<div class="col-md-4" style="align-content: center;">
				<select class="form-select" id="machineOpt" >
				  <option value="0">-Select-</option>
				  <option value="A4 Rubber Sheet">A4 Rubber Sheet</option> 
				</select>  
			</div>
		</div>
		<div class=" row mt-1">
			<label for="Stock Name" class="col-md-2 col-form-label">No. of Pouches</label>
			<div class="col-md-4" style="align-content: center;">
				<input type="text" autocomplete="off" class="form-control numericOnly" id="noOfPouchesTxt" name="noOfPouchesTxt" disabled  /> 
			</div>	
			<label for="Stock Name" class="col-md-2 col-form-label">Stock Usage</label>
			<div class="col-md-4" style="align-content: center;">
				<input type="text" autocomplete="off" class="form-control numericOnly" id="stockUsageTxt" name="stockUsageTxt" disabled  />  
			</div>
		</div>
		<div class=" row mt-1">
