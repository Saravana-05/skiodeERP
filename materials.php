		...
		<div class = "col p-0  bg_gdarkgreen" >
			...
			<div class="row m-1 ">
				<div class="form-check col-6 pl-0	">
				  <input class="form-check-input media_stock_type_txt" type="radio" name="media_stock_type_txt" value="<?php echo $category1;?>-MATERIALS" id="own_stock_type_papers_txt">
