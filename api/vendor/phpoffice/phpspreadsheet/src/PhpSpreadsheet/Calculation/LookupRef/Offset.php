...
class Offset
{
     ...
     * @param int $row The number of rows, up or down, that you want the upper-left cell to refer to.
     ...
     */
    public static function OFFSET(?string $cellAddress = null, $row = 0, $columns = 0, $height = null, $width = null, ?Cell $cell = null): string|array
    {
        /** @var int */
        ...
        $endCellRow = self::adustEndCellRowForHeight($height, $startCellRow, $row, $endCellRow);
     ...
     * @param scalar $row
     */
    private static function adustEndCellRowForHeight($height, int $startCellRow, $row, int $endCellRow): int
    {
