...
class ChooseRowsEtc
{
     ...
     * @return mixed[]|string
     */
    public static function drop(mixed $input, mixed $row = null, mixed $columns = null): array|string
    {
        if (!is_array($input)) {
            $input = [[$input]];
        }
        ...
        $outputArray1 = self::dropRows($inputArray, $row);
     ...
     * @return mixed[]|string
     */
    public static function take(mixed $input, mixed $row, mixed $columns = null): array|string
    {
        if (!is_array($input)) {
            $input = [[$input]];
        }
        ...
        $outputArray1 = self::takeRows($inputArray, $row);
        if (is_string($outputArray1)) {
            return $outputArray1;
        }
        $outputArray2 = self::transpose($outputArray1);
     ...
     * @return mixed[]|string
     */
    public static function expand(mixed $input, mixed $row, mixed $columns = null, mixed $pad = '#N/A'): array|string
    {
        if (!is_array($input)) {
            $input = [[$input]];
        }
