...
class PageSetup
{
     ...
     */
    private array $rowToRepeatAtTop = [0, 0];
     ...
     *
     * @param int[] $rowToRepeatAtTop Containing start column and end column, empty array if option unset
     *
     * @return $this
     */
    public function setRowsToRepeatAtTop(array $rowToRepeatAtTop): static
    {
        $this->rowsToRepeatAtTop = $rowToRepeatAtTop;
