...
{
	$sql="SELECT A.*,B.machine_name FROM job_card_wise_machine_usage as A join machine_master as B on A.machine_code=B.machine_code where jobcard_no=".$_GET['job_card_no'];  
