		...
		<div class=" row">
			<div class="col-md-6" style="align-content: center;">
				<select class="form-select" id="stockOpt">
				  ...
				  <?php
				  if($row=mysqli_query($connection,"select *  from lamination_stock_master   where  is_active=1"))		
					{ 
						while($data=mysqli_fetch_array($row))
						{
							echo '<option value="'.$data["lamination_stock_id"].'">'.$data["lamination_stock_name"].'</option>';           
						}
					}
				  ?>
				</select> 
