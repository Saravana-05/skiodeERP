...
<div class="row m-0 p-0">
		...
		<div class=" row">
			<div class="col-md-6" style="align-content: center;">
				<select class="form-select" id="stockOpt">
				  ...
				  <?php
				  if($row=mysqli_query($connection,"select *  from stickers_stock_master   where  is_active=1"))		
					{ 
						while($data=mysqli_fetch_array($row))
						{
							echo '<option value="'.$data["stickers_stock_id"].'">'.$data["stickers_stock_name"].'</option>';           
						}
					}
				  ?>
				</select> 
	...
	<div class="col-md-8 p-2 machineDiv bg_blue">
		...
		<div class=" row">
			...
			<div class="col-md-2" style="align-content: center;">
				<input type="text" autocomplete="off" class="form-control numericOnly" id="addlCopyTxt" name="addlCopyTxt"  /> 
			</div> 	  
			<div class="col-md-2" style="align-content: center;">
			...
			<div class="col-md-2" style="align-content: center;">
				<select class="form-select" id="machineOpt">
				  <option value="0">-Select-</option>
				  <?php
				  if($row=mysqli_query($connection,"select *  from machine_master   where  is_active=1 and sales_subtype_name='stickers'"))		
					{ 
						while($data=mysqli_fetch_array($row))
						{
